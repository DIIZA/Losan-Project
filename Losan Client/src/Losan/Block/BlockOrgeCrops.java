...
public class BlockOrgeCrops extends BlockFlower //ajout
{
	public BlockOrgeCrops(int par1, int par2)
    {
        super(par1, par2);
        ...
        if (!par1World.isRemote)
        {
            ...
            for (int var9 = 0; var9 < var8; ++var9)
            {
                if (par1World.rand.nextInt(15) <= par5)
                {
                    ...
                    EntityItem var14 = new EntityItem(par1World, (double)((float)par2 + var11), (double)((float)par3 + var12), (double)((float)par4 + var13), new ItemStack(Item.orgeSeeds));
    ...
    {
        return par1 == 7 ? Item.orge.shiftedIndex : -1;
    }
    ...
    {
        return Item.orgeSeeds.shiftedIndex;
    }
}
