...
public class BlockFreezer extends BlockContainer
{
    ...
    {    	
    	...
    	else
    	{
    		...
    		if (var10 != null)
    		{
    			par5EntityPlayer.displayGUIFreezer(var10);
    		}
    ...
    public static void updateFreezerBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlockWithNotify(par2, par3, par4, Block.freezerb.blockID);
        }
        else
        {
            par1World.setBlockWithNotify(par2, par3, par4, Block.freezera.blockID);
        }
