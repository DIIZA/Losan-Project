...
public class SlotFut extends Slot
{
    /** The player that is using the GUI where this slot resides. */
    private EntityPlayer thePlayer;
    private int field_75228_b;

    public SlotFut(EntityPlayer par1EntityPlayer, IInventory par2IInventory, int par3, int par4, int par5)
    {
    ...
    protected void onCrafting(ItemStack par1ItemStack)
    {
        ...
        if (!this.thePlayer.worldObj.isRemote)
        {
            ...
            float var3 = FutRecipes.smelting().func_77601_c(par1ItemStack.itemID);
            int var4;
