...
public class GuiTextField extends Gui
{
  ...
  //ajout
    public void mouseClickedSP(int par1, int par2, int par3, GuiTextField gui)
    {
        boolean var4 = par1 >= this.xPos && par1 < this.xPos + this.width && par2 >= this.yPos && par2 < this.yPos + this.height;

        if(gui.getText().equals("")){
        	if(gui.getMaxStringLength() == 9)
        		gui.setText("ex: 10000");
        	if(gui.getMaxStringLength() == 20)
        		gui.setText("ex: dermenslof");
        }
        ...
        if (this.isFocused && par3 == 0)
        {
            ...
            if(gui.getText().equals("ex: 10000") || gui.getText().equals("ex: dermenslof")){
            	gui.setText("");
            }
            String var6 = this.fontRenderer.trimStringToWidth(this.text.substring(this.field_73816_n), this.getWidth());
            this.setCursorPosition(this.fontRenderer.trimStringToWidth(var6, var5).length() + this.field_73816_n);
    ...
    public boolean mouseClickedSP1(int par1, int par2, int par3, GuiTextField gui)
    {
        boolean var4 = par1 >= this.xPos && par1 < this.xPos + this.width && par2 >= this.yPos && par2 < this.yPos + this.height;

        if(gui.getText().equals("") || gui.getText().equals("Non requis")){
        	if(gui.getMaxStringLength() == 10)
        		gui.setText("0");
        	if(gui.getMaxStringLength() == 11)
        		gui.setText("0");
        }
        ...
        if (this.isFocused && par3 == 0)
        {
            ...
            if(gui.getText().equals("0") || gui.getText().equals("0")){
            	gui.setText("");
            }
            String var6 = this.fontRenderer.trimStringToWidth(this.text.substring(this.field_73816_n), this.getWidth());
            this.setCursorPosition(this.fontRenderer.trimStringToWidth(var6, var5).length() + this.field_73816_n);
    ...
    public boolean mouseClickedPerso(int par1, int par2, int par3, GuiTextField gui)
    {
        boolean var4 = par1 >= this.xPos && par1 < this.xPos + this.width && par2 >= this.yPos && par2 < this.yPos + this.height;
