...
{
    private StringTranslate translator = new StringTranslate("fr_FR");//ajout (en_US/fr_FR)
    ...
    /**
     * Displays the freezer GUI for the passed in furnace entity. Args: tileEntityFurnace
     */
    public void displayGUIFreezer(TileEntityFreezer par1TileEntityFreezer) //ajout
    {
        this.incrementWindowID();
        this.playerNetServerHandler.sendPacketToPlayer(new Packet100OpenWindow(this.currentWindowId, 9, par1TileEntityFreezer.getInvName(), par1TileEntityFreezer.getSizeInventory()));
        this.openContainer = new ContainerFreezer(this.inventory, par1TileEntityFreezer);
        this.openContainer.windowId = this.currentWindowId;
        this.openContainer.addCraftingToCrafters(this);
    }
    
    /**
     * Displays the fut GUI for the passed in furnace entity. Args: tileEntityFurnace
     */
    public void displayGUIFut(TileEntityFut par1TileEntityFut) //ajout
    {
        this.incrementWindowID();
        this.playerNetServerHandler.sendPacketToPlayer(new Packet100OpenWindow(this.currentWindowId, 10, par1TileEntityFut.getInvName(), par1TileEntityFut.getSizeInventory()));
        this.openContainer = new ContainerFut(this.inventory, par1TileEntityFut);
        this.openContainer.windowId = this.currentWindowId;
        this.openContainer.addCraftingToCrafters(this);
    }
    
    private Minecraft mc;//ajout
    
    public void displayGUIPoubelle(TileEntityPoubelle par1TileEntityPoubelle) //ajout
    {
        this.incrementWindowID();
        this.playerNetServerHandler.sendPacketToPlayer(new Packet100OpenWindow(this.currentWindowId, 11, par1TileEntityPoubelle.getInvName(), par1TileEntityPoubelle.getSizeInventory()));
        this.openContainer = new ContainerPoubelle(this.mc.thePlayer.inventory, par1TileEntityPoubelle);
        this.openContainer.windowId = this.currentWindowId;
        this.openContainer.addCraftingToCrafters(this);
    }
}
