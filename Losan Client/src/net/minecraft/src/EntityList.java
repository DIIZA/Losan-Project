...
public class EntityList
{
    ...
    static
    {
        ...
        //custom Entity
        addMapping(EntityRaptor.class, "Raptor", 67, 50000, 7000000);//ajout
        addMapping(EntityGiantRaptor.class, "GiantRaptor", 68, 30000, 3000000);//ajout
        addMapping(EntityVoiture.class, "Voiture", 42);
        //custom Entity
    }
}
