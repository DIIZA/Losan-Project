...
public class TileEntity
{
    ...
    static
    {
        ...
        addMapping(TileEntityFreezer.class, "Freezer");//ajout
        addMapping(TileEntityFut.class, "Fut"); //ajout
        addMapping(TileEntityPoubelle.class, "Poubelle"); //ajout
        addMapping(TileEntityEtagereBois.class, "EtagereBois"); //ajout
    }
}
