...
public class GuiContainerCreative extends InventoryEffectRenderer
{
    ...
    public void initGui()
    {
    	if(CraftingManager.boost == true)
    		this.ActiveSpeed = "\2472Speed-On";
    	else
    		this.ActiveSpeed = "\2474Speed-Off";
        ...
        if (this.mc.playerController.isInCreativeMode())
        {
        	...
        	btn_GuiCraft= new GuiButton(4, i+195, j+40, 67, 20, StatCollector.translateToLocal("Les crafts")); 
        	controlList.add(btn_GuiCraft);
        	btn_GuiShop= new GuiButton(5, i+195, j+60, 67, 20, StatCollector.translateToLocal("Boutique")); 
        	controlList.add(btn_GuiShop);
        	btn_Speed= new GuiButton(6, 3, 3, 47, 20, ""); 
        	controlList.add(btn_Speed);
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        drawCenteredString(this.fontRenderer, this.ActiveSpeed, 25, 8, 0xffffff);
    }
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        if (par1GuiButton.id == 6)
        {
        	...
        	CraftingManager.boost = !CraftingManager.boost;
        }
    }
