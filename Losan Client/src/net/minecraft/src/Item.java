...
import Losan.Item.ItemCar;
import Losan.Item.ItemVerrePlein;
...
public class Item
{
    ...
    public static Item jeton = (new Item(247)).setIconCoord(15, 12).setItemName("jeton").setCreativeTab(CreativeTabs.tabMisc).setTextureFile("/gui/items1.png");//ajout
    public static Item carEmpty = (new ItemCar(248)).setIconCoord(7, 8).setItemName("car").setTextureFile("/gui/items1.png");
    //____________________________________________________________________________________________________________________________________________________________________________
