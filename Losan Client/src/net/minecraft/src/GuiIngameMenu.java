...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.btn_vote= new GuiButton(8, this.width / 2 - 100, this.height / 4 + 72 + var1, "Votez !"); //ajout
    	controlList.add(btn_vote);
    }
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        switch (par1GuiButton.id)
        {
            ...
            case 8:
            {
                ...
                try
                {
                    URI uri = new URI("http://www.mcserv.org/losanfr_3802.html");
                ...
                {
                    Logger.getLogger((java.awt.Menu.class).getName()).log(Level.SEVERE, null, exception);
                }
                break;
            }
        }
