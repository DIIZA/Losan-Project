...
import Losan.Gui.GuiFreezer;
import Losan.Gui.GuiFut;
import Losan.Gui.GuiPoubelle;
...
//        this.playerCloakUrl = "http://skins.minecraft.net/MinecraftCloaks/" + StringUtils.stripControlCodes(this.username) + ".png";
    	this.playerCloakUrl = "http://losan.fr/download-launcheur/mods/capes/" + StringUtils.stripControlCodes(this.username) + ".png";//ajout
    ...
    public void displayGUIFreezer1(TileEntityFreezer par1TileEntityFreezer) //ajout
    {
        this.mc.displayGuiScreen(new GuiFreezer(this.inventory, par1TileEntityFreezer));
    }
    
    public void displayGUIFut(TileEntityFut par1TileEntityFut) //ajout
    {
        this.mc.displayGuiScreen(new GuiFut(this.inventory, par1TileEntityFut));
    }
    
    public void displayGUIPoubelle(IInventory par1IInventory)//ajout
    {
        this.mc.displayGuiScreen(new GuiPoubelle(this.mc.thePlayer.inventory, par1IInventory));
    }
    
    public void displayGUIPoubelle1(IInventory par1IInventory)//ajout
    {
    	 this.mc.displayGuiScreen(new GuiPoubelle(this.mc.thePlayer.inventory, par1IInventory));
    }
}
