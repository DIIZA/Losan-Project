...
//    OBSIDIAN(40, new int[]{4, 10, 8, 5}, 9),
    EMERAUDE(12, new int[]{2, 7, 5, 2}, 10),
    RUBIS(70, new int[]{20, 20, 20, 20}, 20),
    LEZARD(5, new int[]{1, 3, 2, 1}, 15);
