...
public abstract class EntityPlayer extends EntityLiving implements ICommandSender
{
	...
	public float money = 0.0f;//ajout
    public boolean init = false; 
    public Minecraft mc;
    public String nickName;
    
	public ContainerBoutique cont = null;
	public boolean onGuiBoutique = false;
	public ContainerCrafts contCrafts = null;
	public ContainerShop contShop = null;
    ...
    public void onUpdate()
    {
	    	...
	    	if(CraftingManager.boost == true){
	    		if(this.moveForward > 0 && Keyboard.isKeyDown(Keyboard.KEY_F)){
	
	    				this.motionZ = (double)(MathHelper.cos(this.rotationYaw / 180.0F * (float)Math.PI) * MathHelper.cos(this.rotationPitch / 180.0F * (float)Math.PI) *2.5F);
	        			this.motionX = (double)(-MathHelper.sin(this.rotationYaw / 180.0F * (float)Math.PI) * MathHelper.cos(this.rotationPitch / 180.0F * (float)Math.PI) *2.5F);
	        			this.motionY = (double)(-MathHelper.sin(this.rotationPitch / 180.0F * (float)Math.PI) * MathHelper.cos(this.rotationPitch / 180.0F * (float)Math.PI) *2.5F);
	...
	public void displayGUIFreezer(TileEntityFreezer var10){} //ajout

	public void displayGUIFut(TileEntityFut var10){} //ajout

	public void displayGUIPoubelle1(IInventory var10) {} //ajout
}
