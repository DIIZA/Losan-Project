...
class ThreadConnectToServer extends Thread
{
    ...
    public void run()
    {
        try
        {
            ...
            GuiConnecting.getNetClientHandler(this.connectingGui).addToSendQueue(new Packet2ClientProtocol(100, GuiConnecting.func_74254_c(this.connectingGui).session.username, this.ip, this.port));
        }
