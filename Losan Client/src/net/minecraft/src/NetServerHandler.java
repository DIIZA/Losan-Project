...
public class NetServerHandler extends NetHandler
{
    ...
    public void kickPlayerFromServer(String par1Str)
    {
        if (!this.connectionClosed)
        {
            ...
            this.mcServer.getConfigurationManager().sendPacketToAllPlayers(new Packet3Chat("\u00a7e" + this.playerEntity.username + " s'est fait kické."));
    ...
    public void handlePlace(Packet15Place par1Packet15Place)
    {
        ...
        {
            this.playerEntity.playerNetServerHandler.sendPacketToPlayer(new Packet3Chat("\u00a77la hauteur max est de " + this.mcServer.getBuildLimit() + " blocs"));
            var4 = true;
        }
        else
        {
    ...
    public void handleErrorMessage(String par1Str, Object[] par2ArrayOfObj)
    {
        ...
        this.mcServer.getConfigurationManager().sendPacketToAllPlayers(new Packet3Chat("\u00a7e" + this.playerEntity.username + " a quitté le jeu."));
        this.mcServer.getConfigurationManager().playerLoggedOut(this.playerEntity);
        this.connectionClosed = true;
