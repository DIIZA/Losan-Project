...
import Losan.TileEntity.TileEntityEtagereBoisRenderer;
import Losan.TileEntity.TileEntityFut;
import Losan.TileEntity.TileEntityFutRenderer;
import Losan.TileEntity.TileEntityPoubelle;
import Losan.TileEntity.TileEntityPoubelleRenderer;
...
public class TileEntityRenderer
{
    ...
    private TileEntityRenderer()
    {
        ...
        //renderer custom
        this.specialRendererMap.put(TileEntityFut.class, new TileEntityFutRenderer());//ajout
        this.specialRendererMap.put(TileEntityPoubelle.class, new TileEntityPoubelleRenderer());//ajout
        this.specialRendererMap.put(TileEntityEtagereBois.class, new TileEntityEtagereBoisRenderer());//ajout
        //renderer custom
