...
//        return par1Block == Block.obsidian ? this.toolMaterial.getHarvestLevel() == 3 : (par1Block != Block.blockDiamond && par1Block != Block.oreDiamond ? (par1Block != Block.oreEmerald && par1Block != Block.blockEmerald ? (par1Block != Block.blockGold && par1Block != Block.oreGold ? (par1Block != Block.blockSteel && par1Block != Block.oreIron ? (par1Block != Block.blockLapis && par1Block != Block.oreLapis ? (par1Block != Block.oreRedstone && par1Block != Block.oreRedstoneGlowing ? (par1Block.blockMaterial == Material.rock ? true : (par1Block.blockMaterial == Material.iron ? true : par1Block.blockMaterial == Material.anvil)) : this.toolMaterial.getHarvestLevel() >= 2) : this.toolMaterial.getHarvestLevel() >= 1) : this.toolMaterial.getHarvestLevel() >= 1) : this.toolMaterial.getHarvestLevel() >= 2) : this.toolMaterial.getHarvestLevel() >= 2) : this.toolMaterial.getHarvestLevel() >= 2);
        ...
        if (par1Block == Block.obsidian) return this.toolMaterial.getHarvestLevel() >= 3;
        if ((par1Block == Block.blockRubis) || (par1Block == Block.oreRubis)) return this.toolMaterial.getHarvestLevel() >= 3;
        if ((par1Block == Block.blockDiamond) || (par1Block == Block.oreDiamond)) return this.toolMaterial.getHarvestLevel() >= 2;
        if ((par1Block == Block.blockEmerald) || (par1Block == Block.oreEmerald)) return this.toolMaterial.getHarvestLevel() >= 2;
        if ((par1Block == Block.blockGold) || (par1Block == Block.oreGold)) return this.toolMaterial.getHarvestLevel() >= 2;
        if ((par1Block == Block.blockSteel) || (par1Block == Block.oreIron)) return this.toolMaterial.getHarvestLevel() >= 1;
        if ((par1Block == Block.blockLapis) || (par1Block == Block.oreLapis)) return this.toolMaterial.getHarvestLevel() >= 1;
        if ((par1Block == Block.oreRedstone) || (par1Block == Block.oreRedstoneGlowing) || (par1Block == Block.Redstone)) return this.toolMaterial.getHarvestLevel() >= 2;
        if (par1Block.blockMaterial == Material.rock || par1Block.blockMaterial == Material.iron || par1Block.blockMaterial == Material.anvil) return true;
        else
        	return false;
    }
